    ...
    def generate_presentation_pipeline(
        ...
        if has_template:
            ...
            template_instruction = (
                ...
                "画像用レイアウトは、構造・関係・プロセス・比較・リスク構図など、画像が理解を明確に助ける場合だけ使ってください。\n"
                "抽象的な話題に対して汎用的な人物写真や雰囲気画像を無理に生成してはいけません。\n"
                "IMAGE の image_prompt は、文字・ロゴ・ブランド名を含まない、シンプルなビジネス向け図解/アイコン風ビジュアルを英語で指定してください。\n"
            )
        ...
        system_instruction = (
            ...
            "画像生成は最大2枚までに抑え、説明価値が高い場合だけ IMAGE プレースホルダーを使ってください。\n"
