...
def run_visual_quality_audit(client, pptx_path: str, temp_dir: str, model_id: str = "gemini-3.8-flash") -> List[SlideVisualAudit]:
    ...
    if not image_paths:
        return []
    audit_model = model_id if "gemini" in model_id else "gemini-3.8-flash"
